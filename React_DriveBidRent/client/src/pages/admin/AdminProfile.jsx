        ...
        <div className="profile-container" style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
          ...
          <div className="change-password" style={{ flex: 1, minWidth: "300px", background: "#fff", padding: "2rem", borderRadius: "1rem", border: "1px solid #ff6b00", boxShadow: "0 5px 15px rgba(255,107,0,0.1)" }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="update-btn" style={{ display: "block", width: "100%", background: "linear-gradient(135deg, #ff6b00, #ff9a44)", color: "white", padding: "0.75rem 2rem", border: "none", borderRadius: "0.5rem", fontSize: "1rem", cursor: "pointer", fontWeight: 600 }}>
                Update Password
              </button>
            </form>
          </div>
