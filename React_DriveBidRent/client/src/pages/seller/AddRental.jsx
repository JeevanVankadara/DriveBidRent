      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg space-y-6">
          <div>
            ...
            <input type="text" name="vehicle-name" value={formData['vehicle-name']} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-4 py-2" />
          </div>
          <div>
            <label className="block font-medium text-gray-700 mb-2">Vehicle Image</label>
            <input type="file" name="vehicleImage" onChange={handleChange} required accept="image/*" className="w-full" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block font-medium text-gray-700 mb-2">Year</label>
              <input type="number" name="vehicle-year" value={formData['vehicle-year']} onChange={handleChange} required min="1900" max="2025" className="w-full border border-gray-300 rounded-lg px-4 py-2" />
            </div>
            <div>
              <label className="block font-medium text-gray-700 mb-2">AC</label>
              <select name="vehicle-ac" value={formData['vehicle-ac']} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-4 py-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input type="number" name="vehicle-capacity" value={formData['vehicle-capacity']} onChange={handleChange} required min="1" className="w-full border border-gray-300 rounded-lg px-4 py-2" />
            </div>
            <div>
              <label className="block font-medium text-gray-700 mb-2">Condition</label>
              <select name="vehicle-condition" value={formData['vehicle-condition']} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-4 py-2">
                <option value="">Select</option>
            ...
            <div>
              ...
              <select name="vehicle-fuel-type" value={formData['vehicle-fuel-type']} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-4 py-2">
                <option value="">Select</option>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select name="vehicle-transmission" value={formData['vehicle-transmission']} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-4 py-2">
                <option value="">Select</option>
            ...
            <div>
              ...
              <input type="number" name="rental-cost" value={formData['rental-cost']} onChange={handleChange} required min="0" className="w-full border border-gray-300 rounded-lg px-4 py-2" />
            </div>
          </div>
          <div>
            <label className="block font-medium text-gray-700 mb-2">Driver Available</label>
            <select name="driver-available" value={formData['driver-available']} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-4 py-2">
              <option value="">Select</option>
          ...
          <div id="driver-rate-container" style={{ display: 'none' }}>
            ...
            <input type="number" name="driver-rate" value={formData['driver-rate']} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-4 py-2" />
          </div>
          <button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3 rounded-lg hover:from-orange-600 hover:to-orange-700 disabled:opacity-70">
