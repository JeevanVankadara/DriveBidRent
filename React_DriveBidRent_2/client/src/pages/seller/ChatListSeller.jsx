      ...
      <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-white to-gray-50">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Rental communications</p>
          </div>
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search renters or vehicles..."
            value={searchTerm}
          ...
          <div className="flex flex-col items-center justify-center h-64 p-6">
            ...
            <p className="text-gray-500 text-center text-sm max-w-xs">
              {searchTerm 
                ...
                : 'When renters contact you about vehicles, conversations will appear here'}
            </p>
            {searchTerm && (
              <button 
                  ...
                  <div className="p-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-r from-green-400 to-green-500 flex items-center justify-center text-white font-bold text-lg">
