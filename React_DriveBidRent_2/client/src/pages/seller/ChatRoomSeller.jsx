...
export default function ChatRoomSeller({ chatIdProp }) {
  ...
  return (
    <div className="flex flex-col h-full">
      <ChatHeader chat={chat} otherUser={chat?.buyer} carName={chat?.rentalRequest?.vehicleName} rentalPeriod={`${chat?.rentalRequest ? new Date(chat?.rentalRequest?.pickupDate).toLocaleDateString() + ' - ' + new Date(chat?.rentalRequest?.dropDate).toLocaleDateString() : ''}`} />
