...
export default function ChatRoomMechanic({ chatIdProp }) {
  ...
  if (!chatId) {
    return (
      <div className="p-6 text-center text-gray-500">Select an inspection from the left to view messages.</div>
    );
  }

  return (
    <div className="flex flex-col h-full">
      <ChatHeader chat={chat} otherUser={chat?.auctionManager} carName={chat?.inspectionTask?.vehicleName} rentalPeriod={''} currentUserId={myUserId} />
